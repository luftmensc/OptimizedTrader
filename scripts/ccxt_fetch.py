...
def fetch_and_save_candles(symbol, timeframe, num_candles):
    ...
    while fetched_candles < num_candles:
        ...
        now = candles[-1][0] - 1  # Move to the previous candle before the last one
    ...
    with open(csv_filename, mode='w', newline='') as file:
        ...
        # Write each row of candlestick data
...
# Fetch 672 candles for 15-minute timeframe (7 days worth of data)
